...
Имя:<br> <input type="text" name="Name" value="<?=$student->name;?>">
<?php if (isset($validation->errors['name'])) {echo $validation->errors['name'];} ?><br>
Фамилия:<br> <input type="text" name="Surname" value="<?=$student->surname;?>">
...
Номер группы:<br> <input type="text" name="GroupNumber" value="<?=$student->groupNumber;?>">
<?php if (isset($validation->errors['groupNumber'])) {echo $validation->errors['groupNumber'];} ?><br>
e-mail:<br> <input type="email" name="Email" value="<?=$student->email;?>">
<?php if (isset($validation->errors['email'])) {echo $validation->errors['email'];} ?><br>
Оценка за ЕГЭ:<br> <input type="text" name="Mark" value="<?=$student->mark;?>">
...
<br>Год рождения:<br> <input type="text" name="BirthDate" value="<?=$student->birthDate;?>">
